...
public class Update_question {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Update_question window = new Update_question();
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(getClass().getResource("/quiz/Update Question.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon("quiz\\save.png"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(rs.first())
					{
						...
						JFrame jf=new JFrame();
						jf.setAlwaysOnTop(true);
						JOptionPane.showMessageDialog(jf,"Qution id does not exist");
					}
				}
				catch(Exception e1)
				{
